...
\begin{enumerate}
    ...
    \item A cross-LLM consensus labelling protocol, using Claude Haiku 4.5 and GPT-5.4-nano, that yields a 59.5\% inter-model agreement rate and exposes systematic confusions that a single-annotator pipeline would miss.
